  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px] p-0">
        <DialogTitle className="sr-only">Tạo bộ sưu tập mới</DialogTitle>
        <Card className="w-full border-0 shadow-none">
          <CardHeader>
            <CardTitle>Tạo bộ sưu tập mới</CardTitle>
            <CardDescription>
              Tạo một bộ sưu tập flashcard mới để bắt đầu học.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter className="flex-col gap-2">
            ...
            >
              {createLoading ? 'Đang tạo...' : 'Tạo bộ sưu tập'}
            </Button>
            <Button
              type="button"
              variant="outline"
